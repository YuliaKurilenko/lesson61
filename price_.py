...
class PriceMachine():
    ...
    def load_prices(self, folder_path):
        ...
        for file in os.listdir(folder_path):
            if file.endswith('.csv'):
                with open(os.path.join(folder_path, file), 'r', encoding='cp1251') as csv_file:
    ...
    def export_to_html(self, output_file_path=r'C:\Users\User\Downloads\output.html'):
        if self.data:
...
price_machine.load_prices(r'C:\Users\User\Downloads')
